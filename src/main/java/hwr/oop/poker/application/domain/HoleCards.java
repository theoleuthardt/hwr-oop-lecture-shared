...
public class HoleCards {
    ...
    private Map<Player, List<Card>> drawHoleCardsFromDeck(Supplier<Card> cardSupplier, List<Player> players) {
        final var mutableMap = drawCardsToMutableMap(cardSupplier, players);
        return convertToImmutableMap(mutableMap);
    }

    private Map<Player, List<Card>> drawCardsToMutableMap(Supplier<Card> cardSupplier, List<Player> players) {
